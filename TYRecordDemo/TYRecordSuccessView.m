...
@implementation TYRecordSuccessView
...
- (void)setupUI{
    ...
    [cancelButton setImage:[UIImage imageNamed:@"btn_record_re"] forState:UIControlStateNormal];
    [cancelButton addTarget:self action:@selector(reRecordAction) forControlEvents:UIControlEventTouchUpInside];
    ...
    [sendButton setImage:[UIImage imageNamed:@"btn_record_ok"] forState:UIControlStateNormal];
